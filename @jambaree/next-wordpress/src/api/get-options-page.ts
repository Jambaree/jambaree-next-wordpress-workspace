 ...
 * ```
 * @see https://github.com/Jambaree/jambaree-next-wp-plugin for more information.
 */
...
const msg = `'getOptionsPage' requires the 'Jambaree Next WP' plugin to be installed and activated on your WordPress site.
